 ...
 */
public class TafelindelingenTest {
    ...
    public static void showTafelindeling(int toernooi_id) throws SQLException, ClassNotFoundException {
    ...
    static class ScrollablePanelTafelindeling extends JPanel implements Scrollable {
        ...
        public Dimension getPreferredScrollableViewportSize() {
            if (getParent() == null)
                return getSize();
            return new Dimension(10, TafelindelingenTest.getRows() * 305);
        }
